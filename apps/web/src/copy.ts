...
export const appCopy = {
  ...
  realtimeConnectedMessage: "通义千问语音通道已连接，可以开始对话。",
  realtimeConnectionError: "语音通道连接失败，请确认后端服务、DashScope Key 和浏览器授权正常。",
  ...
  visionContextSyncFailed: "视觉摘要暂时无法同步到语音上下文，请先连接语音通道。",
